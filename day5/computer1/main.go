...
//var mem = []int{1,0,0,0,99}
//var mem = []int{1,1,1,4,99,5,6,0,99}
//var mem = []int{2,3,0,3,99}
//var mem = []int{2,4,4,5,99,0}
//var mem = []int{1101,100,-1,4,0}
//var mem = []int{3,1,99}
...
func newInstruction(o int) (instruction, int) {
	var opCode int
	...
	opCode = o - (1000 * paramTwoMode) - (100 * paramOneMode)
